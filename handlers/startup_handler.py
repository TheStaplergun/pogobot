...
async def start_lobby_removal_loop(bot):
    ...
    while True:
        ...
        while True:
            ...
            await RLH.send_log_message(bot, message, lobby.lobby_channel, lobby_data, author=await bot.retrieve_user(lobby_data.get("host_user_id")), guild=await bot.get_guild(lobby_data.get()))
